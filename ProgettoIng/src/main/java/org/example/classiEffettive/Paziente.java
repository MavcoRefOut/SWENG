...
public class Paziente extends Persona {
    ...
    private ArrayList<Condizione> condizioni;
    ...
    public Paziente(Diabetologo diab, String codiceFiscale, String nome, String cognome, Date dataNascita, String email, String username, String password) {
        ...
        condizioni = new ArrayList<Condizione>();
    ...
    public ArrayList<Condizione> getCondizioni() {
        return condizioni;
    }

    public void setCondizioni(ArrayList<Condizione> condizioni) {
        this.condizioni = condizioni;
    }

    public Boolean inserisciCondizione(Condizione condizione){
        return condizioni.add(condizione);
    }
    ...
    public String toString() {
        return "Nome='" + getNome() + '\'' +
                ...
                ", condizioniCount=" + (condizioni != null ? condizioni.size() : 0) +
